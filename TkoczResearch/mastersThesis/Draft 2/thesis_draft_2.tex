...
Having this we state and prove the following.%FINISH!!!
...
\bibitem{BGMN} F. Barthe, O. Guedon, S. Mendelson, and A. Naor. \textit{A probablilistic approach to the geometry of the $l_p^n$ ball}.
...
\bibitem{SZ} G. Schechtman and J. Zinn. \textit{On the volume of the intersection of two L_p^n balls}. 
...
\bibitem{BN} Barthe, F. Naor, A. Hyperplane projections of the unit ball of $l_p^n$. 

\begin{verbatim}
	https://link.springer.com/article/10.1007/s00454-001-0066-3
\end{verbatim}

\bibitem{ENT2} Eskenazis, A. Nayar, P. Tkocz, T. Sharp comparison of moments and the log-concave moment problem.

\begin{verbatim}
	https://arxiv.org/abs/1801.07597
\end{verbatim}

\bibitem{SBS} Stechkin, SB. On best lacunary systems of functions. 

\begin{verbatim}
	http://www.mathnet.ru/php/archive.phtml?wshow=paper&jrnid=im&paperid=3405&option_lang=eng
\end{verbatim}

\bibitem{E} Eaton, M.L. A note on symmetric Bernoulli random variables. 
...
\bibitem{K} On the best possible constants in the Khintchine inequality for $p \geq 3$. 

\begin{verbatim}
	https://academic.oup.com/blms/article-abstract/20/1/73/318987?redirectedFrom=fulltext
\end{verbatim}

\bibitem{P} Best constants in the Kahane-Khintchine inequalities for complex Steinhaus functions. 
...
\bibitem{SS} Spektor, S. Restricted Khinchine inequality. 

\begin{verbatim}
	https://arxiv.org/abs/1708.08095
\end{verbatim}

\bibitem{SP} Pass, B. Spektor, S. On Khintchine type inequalites for $k-wise$ independent Rademacher random variables. 

\begin{verbatim}
	https://arxiv.org/abs/1708.08775
\end{verbatim}

\bibitem{SOR} O'Rourke, S. A note on the Marchenko-Pastur law for  a class of random matrices with dependent entries. 

\begin{verbatim}
	https://arxiv.org/pdf/1201.3554.pdf
\end{verbatim}

\bibitem{KLO} Kwapien, S. Latala, R. Oleskiewicz, K. Comparison of Moments of Sums of Independent Random Variables and Differential Inequalities.
